/**
 * CLI crypto helpers — thin re-exports from @silo/crypto, plus
 ...
 * In CI/CD the SILO_MASTER_KEY env var can override this.
 */
...
export function getMasterKeyBytes(): Uint8Array | null {
  const fromEnv = process.env['SILO_MASTER_KEY'];
